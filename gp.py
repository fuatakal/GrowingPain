...
def main():
    ...
    st.markdown("<h2 style='text-align: center; color: black;'>Please provide values for features below and click the predict button to see how likely your patient has GP.</h2>", unsafe_allow_html=True)
